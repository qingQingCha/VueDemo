...
// [1、根据经纬度获取位置详情](#1 根据经纬度获取位置详情) -- 通过Param形式传参
export const reqAddress = (geohash) => ajax(`/api/position/${geohash}`)
// [2、获取食品分类列表](#2 获取食品分类列表)<br/>
export const reqFoodCategorys = () => ajax('/api/index_category')
// [3、根据经纬度获取商铺列表](#3 根据经纬度获取商铺列表) -- 通过query形式传参
export const reqShops = (longitude, latitude) => ajax('/api/shop', {longitude, latitude})
// [4、根据经纬度和关键字搜索商铺列表](#4 根据经纬度和关键字搜索商铺列表)<br/>
export const reqShopsBySearch = (geohash, keyword) => ajax('/api/search_shops', {geohash, keyword})
